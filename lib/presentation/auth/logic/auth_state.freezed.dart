...
abstract class AuthInitial implements AuthState {
  factory AuthInitial() = _$AuthInitialImpl;
}
...
class _$AuthSuccessImpl implements AuthSuccess {
  _$AuthSuccessImpl(this.response);
...
abstract class AuthSuccess implements AuthState {
  factory AuthSuccess(final LoginResponse response) = _$AuthSuccessImpl;
...
class _$AuthFailureImpl implements AuthFailure {
  _$AuthFailureImpl(this.message);
...
abstract class AuthFailure implements AuthState {
  factory AuthFailure(final String message) = _$AuthFailureImpl;
